        ...
        <div className="-m-6 flex flex-wrap">
          <div className="w-full p-6 md:w-1/2 lg:w-5/12">
            <div className="flex h-full flex-col justify-between">
              <div className="mb-4 inline-flex items-center">
                ...
                <div className='invert w-[100px] h-[100px]'>
                  <img src={exampleImage} alt="logo"/>
                </div>
                {/* <span className="ml-4 text-lg font-bold">Fitflex</span> */}
              </div>
              <div>
                {/* <p className="mb-4  text-base font-medium">The Tailwind CSS Component library</p> */}
                <p className="text-sm text-white">
                  &copy; Copyright 2022. All Rights Reserved by Fitflex.
                </p>
              </div>
            </div>
          </div>
          <div className="w-full p-6 md:w-1/2 lg:w-2/12">
            <div className="h-full">
              ...
              <ul>
                <li className="mb-4">
                  <a className=" text-base font-medium text-gray-300 hover:text-gray-400" href="#">
                    Features
                  </a>
                </li>
                <li className="mb-4">
